...
// Note: 255 is used when there is no territory in that direction
const Territory** territories = new Territory*[TERRITORIES_COUNT] {
  new Territory(0, "Morocco", 255, 1, 19, 2,        NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(1, "Tunisia", 0, 255, 26, 2,        NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(2, "Mali", 255, 3, 0, 255,          NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(3, "Libya", 2, 4, 25, 255,          NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(4, "Egypt", 2, 5, 7, 255,           NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(5, "Arabia", 4, 6, 7, 255,          NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(6, "Persia", 7, 255, 8, 5,          NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(7, "Byzantine", 30, 6, 8, 5,        NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(8, "Georgia", 7, 255, 9, 6,         NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(9, "Russia", 36, 255, 255, 8,       NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(10, "Finland", 11, 36, 255, 36,     NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(11, "Sweden", 12, 10, 255, 22,      NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(12, "Norway", 14, 11, 255, 13,      NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(13, "Denmark", 14, 11, 12, 22,      NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(14, "Scotland", 16, 12, 255, 15,    NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(15, "England", 16, 13, 14, 21,      NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(16, "Ireland", 255, 14, 255, 19,    NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(17, "Galicia", 255, 19, 16, 18,     NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
  new Territory(18, "Portugal", 255, 19, 17, 0,     NULL, TERRITORY_STARTING_SOLDIERS, TERRITORY_STARTING_SOLDIERS_GENERATION_RATE),
...
Territory* GetRandomTerritory(uint8_t* exclude = nullptr, uint8_t amount_to_exclude = 0)
{
  while (true)
  {
    Territory* random_territory = territories[random(TERRITORIES_COUNT)];
